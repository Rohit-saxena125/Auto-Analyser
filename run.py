...
import base64
import io
st.set_page_config(page_title='My Web App For train',
    layout='wide')
def build_model(df):
...
def imagedownload(plt, filename):
    ...
    return href
st.write("""
This App will work for analysis dataset and download training and test data set and download image in pdf
""")
